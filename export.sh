...
cp Scriban-LICENSE.txt up/content
cp .godot/mono/temp/bin/Debug/STS2Export.dll up/content
cp .godot/mono/temp/bin/Debug/Scriban.dll up/content
cp STS2Export.pck up/content
cp mod_manifest.json up/content/STS2Export.json
